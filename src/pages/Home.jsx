...
function Home({ isDarkMode }) {
  ...
  return (
    <div className={`home-wrapper ${isDarkMode ? "dark" : "light"}`}>
      <Helmet>
        <title>Accueil | École Les Jumelles</title>
        <meta
          name="description"
          content="Bienvenue à l'école bilingue Les Jumelles à Porto-Novo. De la maternelle à la terminale, nous offrons un enseignement bilingue innovant et rigoureux."
        />
        <meta
          name="keywords"
          content="École Les Jumelles, école bilingue, Porto-Novo, enseignement, maternelle, primaire, secondaire, anglais, discipline, innovation"
        />
        <link rel="canonical" href="https://zephryr69.github.io/les-jumelles/" />
      </Helmet>
      ...
      <section className="hero-section">
        <div className="hero-text">
          ...
          <p><strong>Notre devise :</strong> <em>Discipline - Suivi - Innovation</em></p>
          <p><strong>Notre vision :</strong> Offrir un enseignement bilingue (français-anglais) dès la maternelle, favorisant l'excellence et l'ouverture sur le monde.</p>

          <Link to="/formations" className="cta-button">Découvrir nos formations</Link>
        ...
        <img src={logo} alt="Logo de l'école Les Jumelles" className="hero-img" />
      </section>
      ...
      >
        <h2>Vie scolaire</h2>
        <p>Explorez les activités, les uniformes, les sorties pédagogiques et les événements festifs qui rythment la vie de nos élèves.</p>
        <Link to="/vie-scolaire" className="cta-button">Découvrir la vie scolaire</Link>
      </section>
      ...
      >
        <h2>Actualités</h2>
        <p>Restez informés des dernières annonces, concours, résultats et événements à venir.</p>
        <Link to="/actualites" className="cta-button">Voir les actualités</Link>
      </section>
